    ...
    <React.Fragment>
      <Row>
        <Col md={6} xl={4}>
          <Card>
            <Card.Body>
              <h6 className="mb-4">Количество учтённых месяцев года</h6>
              <div className="row d-flex align-items-center">
                <div className="col-9">
                  <h3 className="f-w-300 d-flex align-items-center m-b-0">
                    <i className="feather icon-calendar text-c-green f-30 m-r-5" /> 12 месяцев
                  </h3>
                </div>
        ...
        <Col md={6} xl={4}>
          <Card>
            <Card.Body>
              <h6 className="mb-4">Средняя цена реализации</h6>
              <div className="row d-flex align-items-center">
                <div className="col-9">
                  <h3 className="f-w-300 d-flex align-items-center m-b-0">
        ...
        <Col xl={4}>
          <Card>
            <Card.Body>
              <h6 className="mb-4">Выполение годового плана продаж</h6>
              <div className="row d-flex align-items-center">
                <div className="col-9">
                  <h3 className="f-w-300 d-flex align-items-center m-b-0">
        ...
        <Col md={6} xl={8}>
          ...
          <Card>
            <Card.Header>
              <Card.Title as="h5">Динамика товарооборота в сопоставимых ценах</Card.Title>
            </Card.Header>
            <Card.Body>
              <MultiBarChart />
            </Card.Body>
        ...
        <Card className="card-event">
            <Card.Body>
              <div className="row align-items-center justify-content-center">
                <div className="col">
                  <h5 className="m-0">Количество продаваемых ресурсов</h5>
                </div>
              ...
              <h2 className="mt-2 f-w-300">
                45<sub className="text-muted f-14">Ресурсов</sub>
              </h2>
              <h6 className="text-muted mt-3 mb-0">Различных сырьевых групп</h6>
            ...
            <Card.Body className="border-bottom">
              <div className="row d-flex align-items-center">
                ...
                <div className="col">
                  ...
                  <span className="d-block text-uppercase">Крупных продаж</span>
                </div>
              </div>
            </Card.Body>
            <Card.Body>
